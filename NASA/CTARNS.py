...
class CTARNS(ARNS):
    def build_model(self, local_feature_size=3, num_extracted_point=11, window_size=8, global_feature_size=3, frt_feature_size=1, output_node=1,dccnn_kernel_size=3, dccnn_stride=1, dccnn_padding=1, dccnn_dilation=1, dropout=0.01, pcnn_kernel_size=1, pcnn_stride=1, pcnn_padding=0, pcnn_dilation=1, local_n_layers=1, global_n_layers=2, local_using_gb=False, global_using_gb=False):
        return CNN_Transformer_ARNS(local_feature_size, num_extracted_point, window_size, global_feature_size, frt_feature_size, output_node,dccnn_kernel_size, dccnn_stride, dccnn_padding, dccnn_dilation, dropout, pcnn_kernel_size, pcnn_stride, pcnn_padding, pcnn_dilation, local_n_layers, global_n_layers, local_using_gb, global_using_gb)
